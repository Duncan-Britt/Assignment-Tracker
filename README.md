...
This command-line application is my solution to my frustration with my community college's online learning platform not providing the ability for me to see my upcoming assignments for all classes conveniently and in one place. The program allows you to perform all the basic operations that you would expect from a todo-list app using a concise and flexible query language which enables you to 
